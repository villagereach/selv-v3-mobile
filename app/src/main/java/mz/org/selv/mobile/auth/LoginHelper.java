...
public class LoginHelper {
                    ...
                    public void onResponse(String response) {
                        if (response != null) {
                            try {
                                ...
                                String userId = responseObject.getString(KEY_USER_ID); // client
                    ...
                    public void onResponse(String response) {
                        if (response != null) {
                            try {
                                ...
                                int tokenExpiration = responseObject.getInt(KEY_ACCESS_TOKEN);
                                Editor editor = sharedPrefs.edit();
                                editor.putString(KEY_ACCESS_TOKEN, accessToken);
                                editor.putString(KEY_USER_ID, userId);
    ...
    public void remoteLogin(Context loginContext, String username, String password) {
        StringRequest loginRequest = new StringRequest(Method.POST, ACCESS_TOKEN_URI,
                new Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public boolean login(String serverUrl, String username, String password){
